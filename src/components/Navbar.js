        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form className="d-flex" role="search">
              ...
              {/* <button className="btn btn-outline-success" type="submit">Search</button> FOR GREEN COLOUR*/} 
              <button className="btn btn-primary mx-3" type="submit">Search</button> 
            </form>
            <div className={`form-check form-switch text-${props.mode==='light'?'dark':'light'}`}>
              <input className="form-check-input" onClick={props.toggleMode} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
              <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{modemsg}</label>
            </div>
          </div>
        </div>
      </nav>
